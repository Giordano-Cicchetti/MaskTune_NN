...
class svhn(SVHN):
    def __init__(
        ...
        if not (os.path.isdir(self.img_data_dir) and len(os.listdir(self.img_data_dir)) > 0):
            ...
            print(
                f"\n\nstart creating and saving {dataset} dataset of SVHN\n\n")
            ...
            print(f"\n\nfinished creating and saving {dataset} dataset of SVHN\n\n")
            
        print(
                f"\n\nstart loading in main memory {dataset} dataset of SVHN\n\n")
